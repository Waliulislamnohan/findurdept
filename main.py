...
# Streamlit App
st.title("Find your Department")
st.header("Please answer the following questions to find your suited department:")
...
# ---------------------
# Email Input Section
email = st.text_input("Enter your email to save your results:")

# Submit and Process
if st.button("Submit"):
    if not email:  # Check if email is entered
        st.warning("Please enter your email to get your results.")
    else:
